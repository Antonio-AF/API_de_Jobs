...
public class ExceptionHandlerMiddleware
{
    ...
    private readonly JsonSerializerOptions _jasonSerializerOptions;

    public ExceptionHandlerMiddleware(RequestDelegate next)
    {
        _next = next;
        _jasonSerializerOptions = new JsonSerializerOptions
        {
    ...
    private Task handleValidationException(HttpContext context, ValidationException e)
    {
        ...
        return Task.FromResult(context.Response.WriteAsync(JsonSerializer.Serialize(body, _jasonSerializerOptions)));
    }
    ...
    private  Task handleModelNotFoundExceptionAsync(HttpContext context, ModelNotFoundException e)
    {
        ...
        context.Response.StatusCode = body.Status;
        context.Response.ContentType = "application/json";
        return context.Response.WriteAsync(JsonSerializer.Serialize(body, _jasonSerializerOptions));
